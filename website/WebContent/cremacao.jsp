...
<html lang="pt-br">
<head>
  <title>Luto Canaã - Cremação</title>
  <meta charset="utf-8">    
  ...
  <meta name="keywords" content="luto canaa funeral cemiterio familia tristeza morte funeraria cremacao">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6">
            <h2>Cremação</h2>
            <img src="img/page1_img3.jpg" alt="Imagem Cremacao">
            <h1></h1>
            <h3>A cremação é uma realidade crescente no Brasil</h3>
            <p>Adquira conosco a cremação ou plano completo estendendo este serviço a todos os seus dependentes</p>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6">
          <!-- <li class="col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-lg-4 col-md-4 col-sm-4"> -->
            ...
            <form id="contact-form2" class="reservation-form">
              ...
              <fieldset>
                ...
                <input type="hidden" value="Cremacao">
                <div class="clear"></div>
              </fieldset>
