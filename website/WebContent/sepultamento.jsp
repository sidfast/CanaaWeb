...
<html lang="pt-br">
<head>
  <title>Luto Canaã - Plano Sepultamento</title>
  <meta charset="utf-8">    
  ...
  <meta name="keywords" content="luto canaa funeral cemiterio familia tristeza morte funeraria sepultamento">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6">
            <h2 class="pad_top1">Sepultamento</h2>
            <figure><img src="img/page1_img2.jpg" alt=""></figure>
            <h1></h1>
            <h3>Veja abaixo os itens oferecidos para o plano sepultamento</h3>
            ...
            <p>Serviço de orientação e informações 24 horas</p>
            <p>Capela municipais para velório</p>
            <p>Gaveta para sepultamento</p>
            <p>Ossuário</p>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <form id="contact-form2" class="reservation-form">
              <div class="success">Reserva enviada com sucesso! <strong>Nós entraremos em contato em breve.</strong> </div>
              <fieldset>
                <div class="coll-1">
                ...
                <div class="clear"></div>
                <div>
                  <div class="txt-form">Comment</div>
                  <label class="message">
                ...
                <input type="hidden" value="Sepultamento">
                <div class="clear"></div>
              </fieldset>
